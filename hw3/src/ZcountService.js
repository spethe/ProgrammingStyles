...
function ZCounter(wfreqFw,dataStorage){
    
    var dataStorage = dataStorage;
    var zcount =0
    this.countZ = function(word){
        zcount+=(word.match(/z/)||[]).length;
    }
    this.printZcount = function(){
        console.log("The number of occurrences of z are  " + zcount);
    }
    dataStorage.registerWordEvent(this.countZ);
    wfreqFw.registerEndEvent(this.printZcount);
}
...
var zcounter = new ZCounter(wfreqFw, data_storage);
